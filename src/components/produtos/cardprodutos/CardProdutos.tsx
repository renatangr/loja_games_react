  ...
  return (
    <div className="bg-white rounded-2xl h-[406px] w-[233px] relative">
      ...
      <div className="grid gap-2 place-items-center px-2 py-3">
        ...
        <div className="italic text-sm text-gray-700">{produto.categoria?.tipo}</div>
      </div>

      {/* Botão de compra */}
      <div className="grid place-items-center bg-teal-600 px-1 py-3 rounded-b-2xl absolute bottom-0 left-0 w-full">
        <button className="bg-teal-600 text-white text-sm font-medium">Comprar</button>
      </div>
